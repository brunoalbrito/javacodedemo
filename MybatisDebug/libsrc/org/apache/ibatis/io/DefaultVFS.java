...
//	url = "file://d:/a/b/c/cn/java/package1"
//	path = "cn/java/package1"
    InputStream is = null;
    try {
      ...
      URL jarUrl = findJarForResource(url); // 查找jar文件
      if (jarUrl != null) {
        ...
        try {
          ...
          if ("file".equals(url.getProtocol())) {
            ...
            if (file.isDirectory()) { // 如果提供的是目录地址
              if (log.isDebugEnabled()) {
                  log.debug("Listing " + url);
              }
        ...
        for (String child : children) {
          ...
          resources.addAll(list(childUrl, resourcePath)); // 查找子目录的资源
        }
      }
