...
import cn.java.mybatis.mapper.bean.Foo;
import cn.java.mybatis.mapper.bean.FooConstructAnnotaionMap;
import cn.java.mybatis.mapper.bean.FooConstructAutoMap;
import cn.java.mybatis.mapper.resulthandler.FooResultHandler;
...
@CacheNamespace(implementation=cn.java.mybatis.cache.RedisCache.class,eviction=LruCache.class,flushInterval=0,size=1024,readWrite=true,blocking=false)
// 使用哪个缓存
@CacheNamespaceRef(cn.java.mybatis.mapper.FooMapper.class)
public interface FooMapper {  
    ...
    @ResultType(value=cn.java.mybatis.mapper.bean.Foo.class) // 
