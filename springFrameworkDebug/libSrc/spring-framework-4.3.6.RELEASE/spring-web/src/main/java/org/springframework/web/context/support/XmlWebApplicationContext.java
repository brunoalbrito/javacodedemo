...
public class XmlWebApplicationContext extends AbstractRefreshableWebApplicationContext {
	...
	protected void loadBeanDefinitions(XmlBeanDefinitionReader reader) throws IOException {
		String[] configLocations = getConfigLocations(); // array("file.xml"," /WEB-INF/classes/applicationConfigLocation.xml","/WEB-INF/applicationContext.xml")
		// "/WEB-INF/applicationContext.xml"   "/WEB-INF/application*.xml"
		if (configLocations != null) {
			for (String configLocation : configLocations) {
				reader.loadBeanDefinitions(configLocation); // org.springframework.beans.factory.xml.XmlBeanDefinitionReader
			}
		}
	}
