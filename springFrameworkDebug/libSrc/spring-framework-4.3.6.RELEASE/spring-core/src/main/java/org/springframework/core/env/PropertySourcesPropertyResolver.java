...
public class PropertySourcesPropertyResolver extends AbstractPropertyResolver {
	...
	protected <T> T getProperty(String key, Class<T> targetValueType, boolean resolveNestedPlaceholders) {
		if (this.propertySources != null) {
			for (PropertySource<?> propertySource : this.propertySources) { // org.springframework.core.env.MutablePropertySources
//				propertySource === org.springframework.core.env.SystemEnvironmentPropertySource
//				propertySource === org.springframework.core.env.MapPropertySource
//				propertySource === org.springframework.web.context.support.ServletContextPropertySource
//				propertySource === org.springframework.jndi.JndiPropertySource
				if (logger.isTraceEnabled()) {
					logger.trace(String.format("Searching for key '%s' in [%s]", key, propertySource.getName()));
				}
				Object value = propertySource.getProperty(key); // org.springframework.core.env.MutablePropertySources
				if (value != null) {
