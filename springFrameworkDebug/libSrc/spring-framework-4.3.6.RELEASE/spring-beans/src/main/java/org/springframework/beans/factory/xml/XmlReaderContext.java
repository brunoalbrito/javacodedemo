...
public class XmlReaderContext extends ReaderContext {
	...
	public final Environment getEnvironment() {
		return this.reader.getEnvironment(); // org.springframework.web.context.support.StandardServletEnvironment
	}
	...
	public String generateBeanName(BeanDefinition beanDefinition) {
		// reader === org.springframework.beans.factory.xml.XmlBeanDefinitionReader
