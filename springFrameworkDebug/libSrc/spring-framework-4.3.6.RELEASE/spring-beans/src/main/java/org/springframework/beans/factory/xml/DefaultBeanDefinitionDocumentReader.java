...
public class DefaultBeanDefinitionDocumentReader implements BeanDefinitionDocumentReader {
	...
	protected BeanDefinitionParserDelegate createDelegate(
		...
		delegate.initDefaults(root, parentDelegate); // parentDelegate === null
		return delegate;
	}
	...
	protected void importBeanDefinitionResource(Element ele) {
		...
		location = getReaderContext().getEnvironment().resolveRequiredPlaceholders(location); // org.springframework.web.context.support.StandardServletEnvironment
		...
		if (absoluteLocation) {
			try {
				...
				// getReaderContext().getReader() === org.springframework.beans.factory.xml.XmlBeanDefinitionReader
				int importCount = getReaderContext().getReader().loadBeanDefinitions(location, actualResources); // 解析文件
	...
	protected void processAliasRegistration(Element ele) {
		...
		if (valid) {
			try {
				// getReaderContext() === org.springframework.beans.factory.xml.XmlReaderContext
				// getReaderContext().getRegistry() === org.springframework.beans.factory.support.DefaultListableBeanFactory
