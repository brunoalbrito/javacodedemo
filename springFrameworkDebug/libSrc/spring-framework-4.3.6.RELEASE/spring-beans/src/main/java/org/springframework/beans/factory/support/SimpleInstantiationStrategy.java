...
//		owner === org.springframework.beans.factory.support.DefaultListableBeanFactory
		...
		if (bd.getMethodOverrides().isEmpty()) {
			...
			return BeanUtils.instantiateClass(constructorToUse); // 使用构造函数
		}
		else {
			// Must generate CGLIB subclass.
			return instantiateWithMethodInjection(bd, beanName, owner); // 生成子类
		}
	}
