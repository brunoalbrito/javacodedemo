...
public class BeanDefinitionParserDelegate {
	...
	protected void populateDefaults(DocumentDefaultsDefinition defaults, DocumentDefaultsDefinition parentDefaults, Element root) {
		...
		defaults.setLazyInit(lazyInit);  /// org.springframework.beans.factory.xml.DocumentDefaultsDefinition
	...
	public BeanDefinitionHolder parseBeanDefinitionElement(Element ele, BeanDefinition containingBean) {
		...
		if (!StringUtils.hasText(beanName) && !aliases.isEmpty()) {
			beanName = aliases.remove(0); // 删除并返回第一个元素
		...
		AbstractBeanDefinition beanDefinition = parseBeanDefinitionElement(ele, beanName, containingBean); // org.springframework.beans.factory.support.GenericBeanDefinition
	...
	public AbstractBeanDefinition parseBeanDefinitionElement(
		...
		try {
			...
			AbstractBeanDefinition bd = createBeanDefinition(className, parent); // org.springframework.beans.factory.support.GenericBeanDefinition

			parseBeanDefinitionAttributes(ele, beanName, containingBean, bd); // 解析<bean>标签的属性
			bd.setDescription(DomUtils.getChildElementValueByTagName(ele, DESCRIPTION_ELEMENT)); // 解析<bean>标签的子标签<description>

			parseMetaElements(ele, bd); // 解析<bean>标签的子标签<meta>
	...
	public void parseConstructorArgElement(Element ele, BeanDefinition bd) {
		/**
			 <constructor-arg index="0" type="" name=""
			...
			try {
				...
				if (index < 0) {
					...
					try {
						...
						if (bd.getConstructorArgumentValues().hasIndexedArgumentValue(index)) { // org.springframework.beans.factory.support.GenericBeanDefinition
...
//		<idref bean="" />
	...
	public Object parseArrayElement(Element arrayEle, BeanDefinition bd) {
		// <array value-type="" merge="false"></array>
		...
		for (Element entryEle : entryEles) {
			...
			/**
			 	<map key-type="" value-type="">
			 		...
			 		<entry key-ref="" value-type="" value=""></entry>
...
//		namespaceUri == "http://www.springframework.org/schema/aop"
	...
	public BeanDefinitionHolder decorateBeanDefinitionIfRequired(Element ele, BeanDefinitionHolder definitionHolder) {
		// definitionHolder === org.springframework.beans.factory.config.BeanDefinitionHolder
