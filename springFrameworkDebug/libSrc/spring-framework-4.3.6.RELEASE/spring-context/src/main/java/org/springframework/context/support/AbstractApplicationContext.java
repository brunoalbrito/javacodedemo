...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	public void refresh() throws BeansException, IllegalStateException {
		synchronized (this.startupShutdownMonitor) {
			...
			try {
				...
				invokeBeanFactoryPostProcessors(beanFactory); // 扫描applicationContext.xml中实现了BeanFactoryPostProcessor接口的bean，并实例化和调用bean的postProcessBeanDefinitionRegistry(...)方法
	...
	protected void prepareBeanFactory(ConfigurableListableBeanFactory beanFactory) {
		...
		beanFactory.addBeanPostProcessor(new ApplicationContextAwareProcessor(this));  // !!! 钩子
		...
		beanFactory.addBeanPostProcessor(new ApplicationListenerDetector(this)); // !!! 钩子
	...
	public Object getBean(String name) throws BeansException {
		...
		return getBeanFactory().getBean(name); // org.springframework.beans.factory.support.DefaultListableBeanFactory
	}

	@Override
	public <T> T getBean(String name, Class<T> requiredType) throws BeansException {
		assertBeanFactoryActive();
		return getBeanFactory().getBean(name, requiredType); // org.springframework.beans.factory.support.DefaultListableBeanFactory
	}

	@Override
	public <T> T getBean(Class<T> requiredType) throws BeansException {
		assertBeanFactoryActive();
		return getBeanFactory().getBean(requiredType); // org.springframework.beans.factory.support.DefaultListableBeanFactory
	}
	...
	public Resource[] getResources(String locationPattern) throws IOException {
		return this.resourcePatternResolver.getResources(locationPattern); // org.springframework.core.io.support.PathMatchingResourcePatternResolver
	}
