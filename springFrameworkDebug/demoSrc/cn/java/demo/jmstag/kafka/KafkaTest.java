package cn.java.demo.jmstag.kafka;
...
import cn.java.demo.jmstag.kafka.producorservice.KafkaProducerService;
...
public class KafkaTest {
	...
	public static void main(String[] args) throws Exception {
		ApplicationContext context = new ClassPathXmlApplicationContext(
				"classpath:cn/java/demo/jmstag/kafka/applicationContextKafka.xml");
