package cn.java.demo.mapper_mybatis.service.impl;
...
import cn.java.demo.mapper_mybatis.mapper.FooMapper;
...
public class FooServiceImpl implements FooService{
	...
	public void testMethod() {
		...
		try {
			sqlSession = mybatisSessionFactory.openSession(true); // 自动提交的方式打开
