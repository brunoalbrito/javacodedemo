...
public class ConfigurationImpl implements HibernateValidatorConfiguration, ConfigurationState {
	...
	private ConfigurationImpl() {
		...
		if ( isJavaFxInClasspath() ) { // 尝试加载类javafx.application.Application
	...
	public final ValidatorFactory buildValidatorFactory() {
		...
		try {
			if ( isSpecificProvider() ) {
				...
				// validationBootstrapParameters === org.hibernate.validator.internal.xml.ValidationBootstrapParameters
				...
				if ( providerClass != null ) {
					...
					// providerResolver === javax.validation.Validation.DefaultValidationProviderResolver
					List<ValidationProvider<?>> providers = providerResolver.getValidationProviders();
					// 查找文件“META-INF/services/javax.validation.spi.ValidationProvider”
					assert providers.size() != 0; // I run therefore I am
					// providers.get( 0 ) === org.hibernate.validator.HibernateValidator
