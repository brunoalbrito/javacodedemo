...
public class ValidatorImpl implements Validator, ExecutableValidator {
	...
	public final <T> Set<ConstraintViolation<T>> validate(T object, Class<?>... groups) {
		...
		// validationOrder === org.hibernate.validator.internal.engine.groups.DefaultValidationOrder
		ValidationOrder validationOrder = determineGroupValidationOrder( groups );
		
		// getValidationContext() === org.hibernate.validator.internal.engine.ValidationContext.ValidationContextBuilder
		// org.hibernate.validator.internal.engine.ValidationContext.ValidationContextBuilder.forValidate(rootBean)
		// validationContext === org.hibernate.validator.internal.engine.ValidationContext
		ValidationContext<T> validationContext = getValidationContext().forValidate( object );
		
		// valueContext === org.hibernate.validator.internal.engine.ValueContext
	...
	private ValidationOrder determineGroupValidationOrder(Class<?>[] groups) {
		...
		// validationOrderGenerator === org.hibernate.validator.internal.engine.groups.ValidationOrderGenerator
