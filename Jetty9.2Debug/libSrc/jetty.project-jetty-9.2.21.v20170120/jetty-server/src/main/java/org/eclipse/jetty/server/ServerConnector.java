...
public class ServerConnector extends AbstractNetworkConnector
{
    ...
    {
        ServerSocketChannel serverChannel = _acceptChannel; // java.nio.channels.ServerSocketChannel
    ...
    private void accepted(SocketChannel channel) throws IOException
    {
        ...
        configure(socket); // !!!
        _manager.accept(channel); // org.eclipse.jetty.server.ServerConnector.ServerConnectorManager
    }
