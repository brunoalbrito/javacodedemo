...
public class StrategySelectorBuilder {
	...
	public StrategySelector buildSelector(ClassLoaderService classLoaderService) {
		/**
		 !!!!!!!!!
		 */
		final StrategySelectorImpl strategySelector = new StrategySelectorImpl( classLoaderService );//二维的HashMap
		/**
		strategySelector = array(
		 	Dialect.class => array(
		 		"MySQL5" => MySQL5Dialect.class,
		 		"MySQL5InnoDB" => MySQL5InnoDBDialect.class,
		 		...
		 	)
		 	JtaPlatform.class => array(
				"Weblogic"=>WeblogicJtaPlatform.class
				"org.hibernate.service.jta.platform.internal.WeblogicJtaPlatform"=>WeblogicJtaPlatform.class
				...
			)
			...
		 );
