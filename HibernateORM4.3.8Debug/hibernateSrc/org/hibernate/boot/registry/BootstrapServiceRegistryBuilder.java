...
public class BootstrapServiceRegistryBuilder {
	...
	public BootstrapServiceRegistry build() {
		...
		return new BootstrapServiceRegistryImpl(
				...
				strategySelectorBuilder.buildSelector( classLoaderService ),//StrategySelectorImpl
