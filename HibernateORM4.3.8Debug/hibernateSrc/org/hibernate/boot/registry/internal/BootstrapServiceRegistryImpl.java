...
public class BootstrapServiceRegistryImpl
	...
	public BootstrapServiceRegistryImpl(
		 ...
		 */
		this.autoCloseRegistry = autoCloseRegistry;//true
		...
		this.integratorServiceBinding = new ServiceBinding<IntegratorService>(
				this,
				IntegratorService.class,
				integratorService//IntegratorServiceImpl
		);
	}
	...
	public <R extends Service> R getService(Class<R> serviceRole) {
		...
		/**
			...
			(serviceRole ==  IntegratorService.class) --- binding.getService() === org.hibernate.integrator.internal.IntegratorServiceImpl
	...
	public <R extends Service> ServiceBinding<R> locateServiceBinding(Class<R> serviceRole) {
		/**
			serviceRole ==  IntegratorService.class
		 */
