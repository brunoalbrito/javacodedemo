...
public class JavaReflectionManager implements ReflectionManager, MetadataProviderInjector {
	...
	public MetadataProvider getMetadataProvider() {
		...
		return metadataProvider; // org.hibernate.cfg.annotations.reflection.JPAMetadataProvider
	}
	...
	public XClass toXClass(Class clazz) {
		/**
		 	如：clazz == cn.java.hibernate.entity.Teacher
		 	toXClass( clazz, new IdentityTypeEnvironment());
		 */
	...
	public XPackage packageForName(String packageName) throws ClassNotFoundException {
		// getClassLoaderDelegate() === org.hibernate.annotations.common.util.StandardClassLoaderDelegateImpl
	...
	XClass toXClass(Type t, final TypeEnvironment context) {
		/**
		 	new TypeSwitch<XClass>() {}.doSwitch( t );
		 	
		 	new TypeSwitch<XClass>() {}.doSwitch( cn.java.hibernate.entity.Teacher );
		 */
		return new TypeSwitch<XClass>() {
			/**
			 	classType === cn.java.hibernate.entity.Teacher
			 */
			@Override
