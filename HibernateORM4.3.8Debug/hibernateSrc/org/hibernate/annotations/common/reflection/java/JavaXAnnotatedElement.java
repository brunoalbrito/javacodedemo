...
abstract class JavaXAnnotatedElement implements XAnnotatedElement {
	...
	public JavaXAnnotatedElement(AnnotatedElement annotatedElement, JavaReflectionManager factory) {
        this.factory = factory; // org.hibernate.annotations.common.reflection.java.JavaReflectionManager
	...
	public <T extends Annotation> boolean isAnnotationPresent(Class<T> annotationType) {
		// org.hibernate.cfg.annotations.reflection.JPAOverriddenAnnotationReader.isAnnotationPresent( annotationType );
