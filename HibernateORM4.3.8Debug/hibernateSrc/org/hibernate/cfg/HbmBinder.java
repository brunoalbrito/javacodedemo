...
public final class HbmBinder {
	...
	public static void bindRoot(
		...
		final Element hibernateMappingElement = doc.getRootElement(); // <hibernate-mapping  package="">
...
//		}
	...
	public static java.util.List<String> getExtendsNeeded(XmlDocument metadataXml, Mappings mappings) {
		...
		final Element hmNode = metadataXml.getDocumentTree().getRootElement(); // <hibernate-mapping  package="">
