...
public final class AnnotationBinder {
	...
	public static void bindPackage(String packageName, Mappings mappings) {
		...
		try {
			...
			// mappings === org.hibernate.cfg.Configuration.MappingsImpl
			// mappings.getReflectionManager() === org.hibernate.annotations.common.reflection.java.JavaReflectionManager
		...
		if ( pckg.isAnnotationPresent( SequenceGenerator.class ) ) { // 包信息中有使用注解 SequenceGenerator
		...
		if ( pckg.isAnnotationPresent( TableGenerator.class ) ) {  // 包信息中有使用注解 TableGenerator
