...
public final class ServiceBinding<R extends Service> {
	...
	public ServiceBinding(ServiceLifecycleOwner lifecycleOwner, Class<R> serviceRole, R service) {
		...
		this.serviceRole = serviceRole; // 接口名
	...
	public ServiceBinding(ServiceLifecycleOwner lifecycleOwner, ServiceInitiator<R> serviceInitiator) {
		this.lifecycleOwner = lifecycleOwner;//StandardServiceRegistryImpl
		this.serviceRole = serviceInitiator.getServiceInitiated();//!!!!!!!!!! JdbcServices.class;
		this.serviceInitiator = serviceInitiator;//JdbcServicesInitiator.INSTANCE
	}
