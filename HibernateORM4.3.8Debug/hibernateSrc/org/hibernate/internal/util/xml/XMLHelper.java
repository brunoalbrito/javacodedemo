...
public final class XMLHelper {
	...
	public SAXReader createSAXReader(ErrorHandler errorHandler, EntityResolver entityResolver) {
		...
		saxReader.setEntityResolver( entityResolver );//entityResolver = XMLHelper.DEFAULT_DTD_RESOLVER;//new DTDEntityResolver();
		saxReader.setErrorHandler( errorHandler );//errorLogger = new ErrorLogger( resourceName );
		return saxReader;
	}
