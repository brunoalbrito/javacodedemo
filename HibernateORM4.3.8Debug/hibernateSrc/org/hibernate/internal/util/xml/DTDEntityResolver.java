...
public class DTDEntityResolver implements EntityResolver, Serializable {
	...
	private InputSource resolveOnClassPath(String publicId, String systemId, String namespace) {
		// systemId === http://hibernate.sourceforge.net/hibernate-configuration-3.0.dtd
		// namespace === http://hibernate.sourceforge.net/
		InputSource source = null;
		String path = "org/hibernate/" + systemId.substring( namespace.length() ); // org/hibernate/hibernate-configuration-3.0.dtd
