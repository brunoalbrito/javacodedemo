...
public final class SessionFactoryImpl
	...
	public SessionFactoryImpl(//!!!!!!!!!!!
		...
		//!!!!!!!!! new ThreadLocalSessionContext( this );/
		currentSessionContext = buildCurrentSessionContext();//ThreadLocalSessionContext
	...
	public Session getCurrentSession() throws HibernateException {
		...
		return currentSessionContext.currentSession();//!!!!!! ThreadLocalSessionContext.currentSession();
	}
