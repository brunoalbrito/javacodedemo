...
<% 
	request.setAttribute("fetchTplUrl","/test.jsp");
	request.setAttribute("status","1");
	request.setAttribute("msg"," fetch success ...");
%>
{
	"status":"<%=(String)request.getAttribute("status")%>",
	"msg":"<%=(String)request.getAttribute("msg")%>",
	"data":{
		'html':"<%	org.apache.jasper.runtime.JspRuntimeLibrary.include(request,response,(String)request.getAttribute("fetchTplUrl"), out, false); %>",
	}
}
