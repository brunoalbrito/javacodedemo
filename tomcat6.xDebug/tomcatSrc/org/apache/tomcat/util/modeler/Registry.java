...
//                    localRegistry.key=key;
    ...
    public ManagedBean findManagedBean(String name) {
    	...
    	//HashMap==descriptors
        ManagedBean mb=((ManagedBean) descriptors.get(name));//org.apache.catalina.core.StandardServer
        if( mb==null )
            mb=(ManagedBean)descriptorsByClass.get(name);//HashMap === descriptorsByClass
        return mb;
    }
        ...
        throws Exception
    {
        ...
        if( type==null ) {
            type=beanClass.getName();//do here  type = org.apache.catalina.core.StandardServer
        }
        
        // first look for existing descriptor
        /**
         * descriptorsByClass、descriptors
     ...
     * XXX make it private 
     * 
     * @param bean   (new org.apache.catalina.core.StandardServer())
     * @param oname  new ObjectName( "Catalina:type=Server")
     * @param type   null
     * @throws Exception
     */ 
    ...
    public void loadDescriptors( String packageName, ClassLoader classLoader  ) {
        ...
        if( searchedPaths.get( packageName ) != null ) {//HashMap===searchedPaths
            return;
        }
     ...
     * in the parent packages.
     *
     * @param beanClass  org.apache.catalina.core.StandardServer
     * @param type     null
     */
