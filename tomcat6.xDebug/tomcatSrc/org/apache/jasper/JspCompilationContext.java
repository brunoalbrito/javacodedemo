...
public class JspCompilationContext {
    ...
    public Compiler createCompiler() throws JasperException {
        ...
        if (options.getCompilerClassName() != null) {
            jspCompiler = createCompiler(options.getCompilerClassName());//有自己配置编译器类名
        } else {
            if (options.getCompiler() == null) {// 没有自己配置编译器对象
            	System.out.println("--创建JSP编译器-YES-->org.apache.jasper.JspCompilationContext.createCompiler()");
        ...
        jspCompiler.init(this, jsw);//初始化编译器!!!!!!!!!!!!!!
        return jspCompiler;//
    }
    ...
    public String[] getTldLocation(String uri) throws JasperException {
    	...
    	/**
	    	 org.apache.jasper.EmbeddedServletOptions.getTldLocationsCache().getLocation(uri);//
	    	 org.apache.jasper.compiler.TldLocationsCache.getLocation(uri);//
    	 */
    	String[] location = 
            getOptions().getTldLocationsCache().getLocation(uri);// mappings.put("http://cn.java.servlet/mytags-taglib", new String[] { "/WEB-INF/jsp/mytags-taglib.tld", null });
        return location;
    }
    ...
    public void compile() throws JasperException, FileNotFoundException {
    	 ...
    	 */
        createCompiler();//
        if (jspCompiler.isOutDated()||true) {// 检查JSP文件是否被修改了，或者配置文件中有设置超时并且JSP文件超时了
            if (isRemoved()) {
                throw new FileNotFoundException(jspUri);
            }
            try {
            	//System.out.println("org.apache.jasper.JspCompilationContext.compile()---删除生成的Java文件、生成Class文件，重新生成JAVA文件");
            	/**
            	 * 删除生成的Java文件
            	 */
                ...
                /**
			                 ...
			                 把JAVA文件的代码，转换成class文件 org.apache.jasper.compiler.JDTCompiler.generateClass(...)
                 */
