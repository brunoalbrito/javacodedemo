...
class TagFileProcessor {
    ...
    private class TagFileLoaderVisitor extends Node.Visitor {
        ...
        public void visit(Node.CustomTag n) throws JasperException {
            TagFileInfo tagFileInfo = n.getTagFileInfo();// 节点的标签文件信息
            if (tagFileInfo != null) {
    ...
    public void loadTagFiles(Compiler compiler, Node.Nodes page)
        ...
        //TagFileLoaderVisitor.visit(解析出来的节点Node信息)
        page.visit(new TagFileLoaderVisitor(compiler)); // Node.accept(new TagFileLoaderVisitor(compiler));
    }
