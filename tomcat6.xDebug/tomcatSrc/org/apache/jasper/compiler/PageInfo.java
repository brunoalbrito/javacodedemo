...
class PageInfo {
    ...
    public void addTaglib(String uri, TagLibraryInfo info) {
        taglibsMap.put(uri, info);// info == org.apache.jasper.compiler.TagLibraryInfoImpl
    }
    ...
    public String getURI(String prefix) {
        ...
        LinkedList stack = (LinkedList) xmlPrefixMapper.get(prefix); //jspPrefixMapper.put("mtag", "http://cn.java.servlet/mytags-taglib");
        if (stack == null || stack.size() == 0) {
