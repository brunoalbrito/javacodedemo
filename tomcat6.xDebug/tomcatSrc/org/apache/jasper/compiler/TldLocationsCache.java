...
public class TldLocationsCache {
    ...
    public String[] getLocation(String uri) throws JasperException {
        if (!initialized) {
            init();// mappings.put("http://cn.java.servlet/mytags-taglib", new String[] { "/WEB-INF/jsp/mytags-taglib.tld", null });
        }
    ...
    private void init() throws JasperException {
        ...
        try {
            processWebDotXml();// mappings.put("http://cn.java.servlet/mytags-taglib", new String[] { "/WEB-INF/jsp/mytags-taglib.tld", null });
            scanJars();
            processTldsInFileSystem("/WEB-INF/");// mappings.put("http://cn.java.servlet/mytags-taglib", new String[] { "/WEB-INF/jsp/example-taglib.tld", null });
            initialized = true;
        } catch (Exception ex) {
    ...
    private void processWebDotXml() throws Exception {
        ...
        try {
            ...
            if (altDDName != null) {
                ...
                webtld = pu.parseXMLDocument(WEB_XML, ip);// "/WEB-INF/web.xml" !!!!!!!!!!
            }
    ...
    private void processTldsInFileSystem(String startPath)
        ...
        Set dirList = ctxt.getResourcePaths(startPath);// "/WEB-INF/"
        if (dirList != null) {
            ...
            while (it.hasNext()) {
                ...
                String uri = null;
                try {
                    uri = getUriFromTld(path, stream);//从tld文件中取得URI信息
                } finally {
                    if (stream != null) {
                        try {
                            stream.close();
        ...
        throws JasperException
    {
        ...
        TreeNode uri = tld.findChild("uri"); //<uri>http://tomcat.apache.org/example-taglib</uri>
        if (uri != null) {
