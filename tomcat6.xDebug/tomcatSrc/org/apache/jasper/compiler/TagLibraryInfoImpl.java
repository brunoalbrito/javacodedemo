    ...
    public TagLibraryInfoImpl(JspCompilationContext ctxt, ParserController pc,
        ...
        try {
            if (!location[0].endsWith("jar")) {
                ...
                try {
                    in = getResourceAsStream(location[0]);// location = new String[] { "/WEB-INF/jsp/mytags-taglib.tld", null }
                    if (in == null) {
                ...
                /**
                 * !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                 * 	解析TLD文件  location[0] === "/WEB-INF/jsp/mytags-taglib.tld"，构造对象树
                 * !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                 */
                parseTLD(ctxt, location[0], in, null);//!!!!!!!!! 
                // Add TLD to dependency list
                PageInfo pageInfo = ctxt.createCompiler().getPageInfo();// org.apache.jasper.compiler.PageInfo
                if (pageInfo != null) {
                    pageInfo.addDependant(location[0]); // org.apache.jasper.compiler.PageInfo.addDependant("/WEB-INF/jsp/mytags-taglib.tld");
                }
            } else {
    ...
    private void parseTLD(JspCompilationContext ctxt, String uri,
        ...
        while (list.hasNext()) {
            ...
            if ("tlibversion".equals(tname) // JSP 1.1
            	 ...
            	 */
                tagVector.addElement(createTagInfo(element, jspversion));//!!!!!!!!!!!!!!! 解析<tag>标签的配置信息
            	...
            	/**
            	   	...
            	   	<tag-file>
            	 		<name>echo</name>
    	 				<path></path>
    	 				<description>标签文件描述</description>
            	 	</tag-file>
            	 */
    ...
    private TagInfo createTagInfo(TreeNode elem, String jspVersion)
        ...
        /**
			  <tag>
				    ...
				    <body-content>JSP</body-content>//子内容
				    <description>
        ...
        while (list.hasNext()) {
            ...
            } else if ("attribute".equals(tname)) {//属性
            	/**
            	 	<attribute>
				      <name>att2</name>
				      <required>true</required>
				      ...
				      <type>Boolean</type>
				      <description>会被忽略</description>
				    </attribute>
			        <attribute>
				      <name>att2</name>
				      <required>true</required>
				      <rtexprvalue>..</rtexprvalue>
				      <type>Byte/Character/Double/Float/....</type>
				      <fragment>...</fragment>
				      <deferred-value>
						<type>java.lang.Object</type>
					  </deferred-value>
					  <deferred-method>
						<method-signature>java.lang.Object method()</method-signature>
					  </deferred-method>
					  <description>会被忽略</description>
				    </attribute>
            	 */
