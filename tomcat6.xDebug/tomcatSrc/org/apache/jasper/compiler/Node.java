...
abstract class Node implements TagConstants {
    ...
    public static class IncludeDirective extends Node {
        ...
        public IncludeDirective(String qName, Attributes attrs,
                Attributes nonTaglibXmlnsAttrs, Attributes taglibAttrs,
                Mark start, Node parent) {
        	//jsp:directive.include,directive.include
    ...
    public static class Nodes {
        ...
        public void visit(Visitor v) throws JasperException {
            ...
            while (iter.hasNext()) {//迭代JSP文件解析处理的nodes列表
                Node n = (Node) iter.next();
                /**
	                 n = org.apache.jasper.compiler.Node.JspText
	                 n = org.apache.jasper.compiler.Node.ELExpression
	                 n = org.apache.jasper.compiler.Node.Comment
	                 n = org.apache.jasper.compiler.Node.Scriptlet
	                 n = org.apache.jasper.compiler.Node.PageDirective
	                 ...
	                 
	                 v = org.apache.jasper.compiler.Generator.GenerateVisitor
	                 
	                 org.apache.jasper.compiler.Generator.GenerateVisitor.visit(org.apache.jasper.compiler.Node.Comment);   
	                 org.apache.jasper.compiler.Generator.GenerateVisitor.visit(org.apache.jasper.compiler.Node.PageDirective);   
                 */
                n.accept(v); // 调用node的方法accept   
            }
        }
