...
public class TagPluginManager {
	...
	InputStream is = ctxt.getResourceAsStream(TAG_PLUGINS_XML);// "/WEB-INF/tagPlugins.xml"
	if (is == null)
	    return;
	...
	TreeNode root = pu.parseXMLDocument(TAG_PLUGINS_XML, is); // "/WEB-INF/tagPlugins.xml"
	if (root == null) {
	    return;
	}
