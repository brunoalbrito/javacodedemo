...
public class ELFunctionMapper {
    ...
    public static void map(Compiler compiler, Node.Nodes page) 
        ...
        page.visit(map.new ELFunctionVisitor());//构造字符串
        ...
        if (ds.length() > 0) {
        	/**
        	 	static {
	             	...
	             	_jspx_fnmap_0.mapFunction("prefix:name",MyFunctionClass.class,"methodName",new Class[] {
	             		MyParamClazz.class,java.lang.reflect.Array.newInstance(MyParamClazz.class,0).getClass()
	             	});
             	}
        	 */
    ...
    class ELFunctionVisitor extends Node.Visitor {
        ...
        private void doMap(ELNode.Nodes el) 
            ...
            el.visit(fv);
            ArrayList functions = fv.funcs;//函数列表
            ...
            decName = getMapName(); //_jspx_fnmap_0  _jspx_fnmap_1
            ...
            /**
             	...
             	_jspx_fnmap_0.mapFunction("prefix:name",MyFunctionClass.class,"methodName",new Class[] {
             		MyParamClazz.class,java.lang.reflect.Array.newInstance(MyParamClazz.class,new int[3]).getClass()
             	});
             */
            ds.append("  " + decName + "= ");
