...
public class JspUtil {
    ...
    public static String interpreterCall(boolean isTagFile,
                     String expression,
                                         ...
                                         boolean XmlEscape ) 
    {
//    JspUtil.interpreterCall(this.isTagFile, "${param.attrName1}", java.lang.String.class,n.getEL().getMapName(), false);
        /*
     ...
     * type.
         */
    String targetType = getCanonicalName(expectedType); //java.lang.String.class
    ...
    /**
     (java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${param.attrName1}", java.lang.String.class, (PageContext)_jspx_page_context, null, false)
     */
...
//        }
    ...
    throws JasperException, IOException {
        ...
        System.out.println("fname:"+fname);//  fname:/index.jsp
