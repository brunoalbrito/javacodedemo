...
public final class EmbeddedServletOptions implements Options {
    ...
    public EmbeddedServletOptions(ServletConfig config,
        ...
        String keepgen = config.getInitParameter("keepgenerated");//每次都重新生成Servlet
        if (keepgen != null) {
        ...
        String trimsp = config.getInitParameter("trimSpaces");//去除空格
        if (trimsp != null) {
        ...
        String checkInterval = config.getInitParameter("checkInterval");//定时检查
        ...
        String javaEncoding = config.getInitParameter("javaEncoding");//JAVA编码
        if (javaEncoding != null) {
            this.javaEncoding = javaEncoding;
        }

        String compilerClassName = config.getInitParameter("compilerClassName");//编译器类
        if (compilerClassName != null) {
            this.compilerClassName = compilerClassName;
        }

        String fork = config.getInitParameter("fork");//分支
        if (fork != null) {
        ...
        jspConfig = new JspConfig(context); // context == org.apache.catalina.core.ApplicationContextFacade

        // Create a Tag plugin instance
        tagPluginManager = new TagPluginManager(context);//标签插件管理器
    }
