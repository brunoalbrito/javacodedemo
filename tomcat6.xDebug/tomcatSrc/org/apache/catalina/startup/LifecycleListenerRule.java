...
public class LifecycleListenerRule extends Rule {
    ...
    public LifecycleListenerRule(String listenerClass, String attributeName) {
        ...
        this.listenerClass = listenerClass;//org.apache.catalina.startup.ContextConfig
        this.attributeName = attributeName;//configClass
    ...
    public void begin(String namespace, String name, Attributes attributes)
        ...
        if (attributeName != null) {//使用这个"configClass"
        ...
        if (p != null && className == null) {//取得父亲节点对configClass的配置
            String configClass =
                (String) IntrospectionUtils.getProperty(p, attributeName);//使用这个"configClass"
        ...
        // Use the default
        if (className == null) {
            className = listenerClass;//都没有匹配到，就使用：org.apache.catalina.startup.ContextConfig
        }
