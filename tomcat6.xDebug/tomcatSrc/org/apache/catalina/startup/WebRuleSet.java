...
public class WebRuleSet extends RuleSetBase {
    ...
    public void addRuleInstances(Digester digester) {
        ...
        digester.addCallMethod(prefix + "web-app/jsp-config/jsp-property-group/url-pattern",
                               "addJspMapping", 0); // org.apache.catalina.core.StandardContext
        ...
        /**
         <web-app>
         	<servlet>
         		...
         		<servlet-class>cn.java.servlet.MyServlet</servlet-class>
        ...
        digester.addRule(prefix + "web-app/servlet",
                         new WrapperCreateRule());//!!!!!!!!!!!!!!!!!! Servlet 被org.apache.catalina.core.StandardWrapper包裹
        ...
        digester.addRule(prefix + "web-app/servlet-mapping",
                               new CallMethodMultiRule("addServletMapping", 2, 0));//添加映射
        ...
        /**
         	...
         	.addTaglib("taglib-location","taglib-uri");
         */
