...
public final class LifecycleSupport {
    ...
    public LifecycleSupport(Lifecycle lifecycle) {
        ...
        super();
        this.lifecycle = lifecycle;//new org.apache.catalina.core.StandardServer()
     ...
     */
    public void fireLifecycleEvent(String type, Object data) {//init
    	//INIT_EVENT, null
        if (Lifecycle.INIT_EVENT.equals(type)) {//初始化事件
            state = "INITIALIZED";
         ...
         */
        /**
         * lifecycle：表示触发者 org.apache.catalina.core.StandardServer
         * type：表示事件类型  String org.apache.catalina.Lifecycle.INIT_EVENT
         * data：表示事件要附加的数据
         */
        LifecycleEvent event = new LifecycleEvent(lifecycle, type, data);
        LifecycleListener interested[] = listeners;//监听器列表
        for (int i = 0; i < interested.length; i++)//迭代触发监听器
