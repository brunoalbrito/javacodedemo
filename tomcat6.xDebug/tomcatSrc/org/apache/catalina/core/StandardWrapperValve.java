...
final class StandardWrapperValve
    ...
    public final void invoke(Request request, Response response)
        ...
        /**
         * 设置两个属性
         * request.setAttribute(org.apache.catalina.core.DISPATCHER_TYPE,new Integer(8))
         * request.setAttribute(org.apache.catalina.core.DISPATCHER_REQUEST_PATH，request.getRequestPathMB())
         *
         * request.setAttribute === attributes.put(name, value)
         */
        ...
        try {
        	//	org.apache.catalina.core.StandardWrapper.getJspFile()
            String jspFile = wrapper.getJspFile();// wrapper是<servlet>解析处理的描述
            if (jspFile != null)//如果包装的是JSP文件？？？？这样吗？
