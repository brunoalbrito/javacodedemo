...
public class StandardEngine
    ...
    public StandardEngine() {
        ...
        super();
        pipeline.setBasic(new StandardEngineValve());//protected Pipeline pipeline = new StandardPipeline(this);
    ...
    public void init() {
        ...
        if( oname==null ) {
            ...
            try {
                ...
                Registry.getRegistry(null, null)
                    .registerComponent(this, oname, null);//执行进来
            } catch( Throwable t ) {
                log.info("Error registering ", t );
            }
        }

        if( mbeansFile == null ) {//执行进来
        ...
        if( mbeansFile != null ) {//没有执行进来
            readEngineMbeans();
        }
        if( mbeans != null ) {//没有执行进来
            try {
