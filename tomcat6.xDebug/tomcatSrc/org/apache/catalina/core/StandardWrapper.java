...
public class StandardWrapper
    ...
    public StandardWrapper() {
        ...
        pipeline.setBasic(swValve);//管道默认处理方法
    ...
    public synchronized void load() throws ServletException {
        instance = loadServlet();//!!!!!!!! org.apache.catalina.core.StandardContext.loadOnStartup(..)中调用
    }
    ...
    public synchronized Servlet loadServlet() throws ServletException {
        ...
        try {
            ...
            //
            if ((actualClass == null) && (jspFile != null)) {//如果访问的是JSP页面   即，没有配置
            	/**
            	  	<servlet>
                ...
                Wrapper jspWrapper = (Wrapper)
                    ((Context) getParent()).findChild(Constants.JSP_SERVLET_NAME);//jsp 的Servlet，Tomcat的核心中web.xml中有声明
                if (jspWrapper != null) {
                	
                    actualClass = jspWrapper.getServletClass();// org.apache.jasper.servlet.JspServlet
                    System.out.println("org.apache.catalina.core.StandardWrapper.loadServlet() ---- "+actualClass);
            ...
            ClassLoader classLoader = loader.getClassLoader();//!!!!!!!!!!!类加载器
            ...
            try {
                if (SecurityUtil.isPackageProtectionEnabled()){//包含型的包
            ...
            // allowed
            if (!isServletAllowed(servlet)) {//不允许访问Servlet？
            ...
            if ((servlet instanceof ContainerServlet) &&
                  (isContainerProvidedServlet(actualClass) ||
                    ((Context)getParent()).getPrivileged() )) {
                ((ContainerServlet) servlet).setWrapper(this);//如果是容器类的Servlet，把wrapper设置进去
            }
            ...
            try {
                ...
                if( Globals.IS_SECURITY_ENABLED) {//安全访问
                ...
                if ((loadOnStartup >= 0) && (jspFile != null)) {//如果访问的是JSP文件
                    // Invoking jspInit
                    DummyRequest req = new DummyRequest();
                    req.setServletPath(jspFile);//!!!!!!!JSP文件
                    ...
                    if( Globals.IS_SECURITY_ENABLED) {
                        ...
                        servlet.service(req, res);//不要求是安全访问，那么直接访问
                    }
                }
    ...
    protected void registerJMX(StandardContext ctx) {
        ...
        if (isJspServlet) {//如果是JSP 的 Servlet
