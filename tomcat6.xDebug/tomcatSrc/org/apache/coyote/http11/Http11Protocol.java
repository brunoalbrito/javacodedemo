...
public class Http11Protocol extends AbstractProtocol
    ...
    public Http11Protocol() {
        ...
        setSoTimeout(Constants.DEFAULT_CONNECTION_TIMEOUT);//连接超时
    ...
    public void init() throws Exception {
    	//http-encodedAddr80
        endpoint.setName(getName());//JIoEndpoint.setName(getName())
        /**
         * 设置请求处理器
         * 最终是调用这个处理器来处理请求
         * org.apache.coyote.http11.Http11Protocol.Http11ConnectionHandler.Http11ConnectionHandler
         */
        endpoint.setHandler(cHandler);//JIoEndpoint.setHandler(new Http11ConnectionHandler(this));

        // Verify the validity of the configured socket factory
        try {
            if (isSSLEnabled()) {//ssl连接
                sslImplementation =
        ...
        try {
             ...
             */
        	endpoint.init();//JIoEndpoint.init()
        } catch (Exception ex) {
    ...
    public void start() throws Exception {
        ...
        try {
        	 ...
        	 */
            endpoint.start();//JIoEndpoint.start()
        } catch (Exception ex) {
    ...
    protected static class Http11ConnectionHandler implements Handler {
        ...
        public boolean process(Socket socket) {
            ...
            try {
                ...
                if (processor == null) {
                    processor = createProcessor();//创建处理器 new Http11Processor();
                }

                if (processor instanceof ActionHook) {
                	//Http11Processor.action，填写一下标志位 started = true;
                ...
                processor.process(socket);//进行处理 !!!	(new Http11Processor()).process(socket);
                return false;
