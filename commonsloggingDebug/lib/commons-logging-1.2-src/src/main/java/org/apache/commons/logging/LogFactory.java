...
public abstract class LogFactory {
    ...
    public static LogFactory getFactory() throws LogConfigurationException {
        ...
        if (factory == null) {
            if (props != null) {
                ...
                String factoryClass = props.getProperty(FACTORY_PROPERTY); // "org.apache.commons.logging.LogFactory"
                if (factoryClass != null) {
                    if (isDiagnosticsEnabled()) {
                        logDiagnostic(
        ...
        if (factory == null) {
            ...
            factory = newFactory(FACTORY_DEFAULT, thisClassLoader, contextClassLoader); // org.apache.commons.logging.impl.LogFactoryImpl
        }
    ...
    public static Log getLog(Class clazz) throws LogConfigurationException {
        return getFactory().getInstance(clazz); // org.apache.commons.logging.impl.LogFactoryImpl
    }
