...
public class JspUtil {
    ...
    public static void checkAttributes(String typeOfTag, Node n,
            ...
            throws JasperException {
        Attributes attrs = n.getAttributes(); // 节点的属性
        ...
        Node.Nodes tagBody = n.getBody(); // 取得body内容
        if (tagBody != null) {
        ...
        for (int j = 0; j < attrLeftLength; j++) { // 迭代余下的属性
            valid = false;
    ...
    public static String getTagHandlerClassName(String path, String urn,
        ...
        index = path.indexOf(WEB_INF_TAGS); // /WEB-INF/tags/dir1/tag1.tag
        if (index != -1) {
        ...
        // return "org.apache.jsp.tag.web.dir1.tag1_tag";
        return className;
    }
    ...
    public static final String makeJavaPackage(String path) {
        ...
        for (int i = 0; i < classNameComponents.length; i++) {
            legalClassNames.append(makeJavaIdentifier(classNameComponents[i])); // 转成java的格式
            if (i < classNameComponents.length - 1) {
                legalClassNames.append('.');
            }
        }
        return legalClassNames.toString(); // return "dir1.tag1_tag"
    }
    ...
    private static final String makeJavaIdentifier(String identifier,
        ...
        return modifiedIdentifier.toString(); // index_jsp
    }
