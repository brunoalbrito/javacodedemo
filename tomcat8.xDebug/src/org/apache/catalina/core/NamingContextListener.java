...
public class NamingContextListener
    ...
    public javax.naming.Context getEnvContext() {
    	//envCtx === org.apache.naming.NamingContext
        return this.envCtx;
    }
    ...
    public void lifecycleEvent(LifecycleEvent event) {
    	...
    	// container === org.apache.catalina.core.StandardContext
        ...
        if (Lifecycle.CONFIGURE_START_EVENT.equals(event.getType())) {
            ...
            try {
                ...
                ContextAccessController.setWritable(getName(), token); // readOnlyContexts.remove("/Catalina/localhost/webapp1");
                ...
                if (container instanceof Context) {
                    ...
                    ContextAccessController.setReadOnly(getName()); // readOnlyContexts.put("/Catalina/localhost/webapp1", "/Catalina/localhost/webapp1");
                    try {
                    	// context = objectBindings.get(StandardContext);
                    	// clBindings.put(((Context) container).getLoader().getClassLoader(), context);
                    	// clObjectBindings.put(((Context) container).getLoader().getClassLoader(), StandardContext);
    ...
    private void createNamingContext()
        ...
        ContextResourceLink[] resourceLinks =
            namingResources.findResourceLinks();  // org.apache.catalina.deploy.NamingResourcesImpl
