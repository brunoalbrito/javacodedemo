...
public abstract class ContainerBase extends LifecycleMBeanBase
    ...
    public void addContainerListener(ContainerListener listener) {
        listeners.add(listener); // org.apache.catalina.mapper.MapperListener
    }
    ...
    protected synchronized void startInternal() throws LifecycleException {
        ...
        logger = null;
        getLogger();
        Cluster cluster = getClusterInternal(); // 启动集群
...
//        children[i] = org.apache.catalina.core.StandardHost
//         		children[i] = org.apache.catalina.core.StandardContext
...
//    	如：context.fireContainerEvent("beforeContextAttributeReplaced", listener);
        if (listeners.size() < 1)
            return;

        ContainerEvent event = new ContainerEvent(this, type, data);
        // Note for each uses an iterator internally so this is safe
        for (ContainerListener listener : listeners) { // 如 listener == org.apache.catalina.mapper.MapperListener
    ...
    protected class ContainerBackgroundProcessor implements Runnable {
        ...
        protected void processChildren(Container container) {
            ...
            try {
                if (container instanceof Context) { // 如果是上下文的子类
