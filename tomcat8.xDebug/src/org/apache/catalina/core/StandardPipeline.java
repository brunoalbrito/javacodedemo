...
//    org.apache.catalina.core.StandardEngineValve
    ...
    protected synchronized void startInternal() throws LifecycleException {
        ...
        Valve current = first;
        if (current == null) {
            current = basic; // org.apache.catalina.core.StandardContextValve
        }
        while (current != null) {
...
//    	org.apache.catalina.core.StandardEngine.StandardEngine() 在构造函数内调用本方法
//   	 valve = org.apache.catalina.core.StandardEngineValve
        ...
        if (valve instanceof Contained) {
            ((Contained) valve).setContainer(this.container); // !!!设置对父类的依赖
        }
