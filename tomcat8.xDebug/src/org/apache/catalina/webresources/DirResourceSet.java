...
public class DirResourceSet extends AbstractFileResourceSet {
    ...
    public DirResourceSet(WebResourceRoot root, String webAppMount, String base,
        ...
        // org.apache.catalina.core.StandardContext.getAddWebinfClassesResources()
        if (root.getContext().getAddWebinfClassesResources()) { // false
        ...
        if (getRoot().getState().isAvailable()) { // 没有走进来
            try {
                start();
    ...
    public WebResource getResource(String path) {
        ...
        WebResourceRoot root = getRoot(); // org.apache.catalina.webresources.StandardRoot
        if (path.startsWith(webAppMount)) { // "/WEB-INF/web.xml".startsWith("")  为true
        	// 创建文件对象
        	// f = new File("d:/a/b/c/tomcat/webapps/dir1/WEB-INF/web.xml")
