...
public class MapperListener extends LifecycleMBeanBase
    ...
    public MapperListener(Service service) {
        this.service = service; // !!! org.apache.catalina.core.StandardService
    ...
    private void findDefaultHost() {
        ...
        if (defaultHost != null && defaultHost.length() >0) {
            Container[] containers = engine.findChildren(); // org.apache.catalina.core.StandardHost
    ...
    private void addListeners(Container container) {
        container.addContainerListener(this);  //org.apache.catalina.core.StandardEngine
        container.addLifecycleListener(this);
        for (Container child : container.findChildren()) {
            addListeners(child); // org.apache.catalina.core.StandardHost
        }
    }
