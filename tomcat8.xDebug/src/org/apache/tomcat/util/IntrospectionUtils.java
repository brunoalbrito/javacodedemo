...
public final class IntrospectionUtils {
    ...
    public static boolean setProperty(Object o, String name, String value,
        ...
        try {
            Method methods[] = findMethods(o.getClass()); // 发射出方法列表
            ...
            for (int i = 0; i < methods.length; i++) { //
                ...
                if (setter.equals(methods[i].getName()) && paramT.length == 1
                        && "java.lang.String".equals(paramT[0].getName())) { // 参数是字符串类型
            ...
            for (int i = 0; i < methods.length; i++) {
                ...
                if (setter.equals(methods[i].getName())
                    ...
                    if ("java.lang.Integer".equals(paramType.getName())
                            || "int".equals(paramType.getName())) { // 参数是Integer类型
                        try {
                    ...
                    // Try a setFoo ( long )
                                ...
                                || "long".equals(paramType.getName())) { // 参数是 Long类型
                            try {
                        ...
                        // Try a setFoo ( boolean )
                            ...
                            || "boolean".equals(paramType.getName())) { // 参数是 Boolean 类型
                        params[0] = Boolean.valueOf(value);

                        // Try a setFoo ( InetAddress )
                    } else if ("java.net.InetAddress".equals(paramType
                            .getName())) { // 目标方法的参数类似是InetAddress，进行wrap再进行设置
                        try {
            ...
            if (invokeSetProperty && (setPropertyMethodBool != null ||
                    setPropertyMethodVoid != null)) { //使用setProperty进行设置属性
                ...
                if (setPropertyMethodBool != null) {
                    try {
                        return ((Boolean) setPropertyMethodBool.invoke(o,
                                params)).booleanValue(); // 设置属性，并取得返回值
