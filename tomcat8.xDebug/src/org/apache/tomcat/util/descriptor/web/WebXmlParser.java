...
public class WebXmlParser {
    ...
    public WebXmlParser(boolean namespaceAware, boolean validation,
        ...
        webRuleSet = new WebRuleSet(false);  // <web-app>
        webDigester = DigesterFactory.newDigester(validation,
                namespaceAware, webRuleSet, blockExternal); //  webRuleSet.addRuleInstances(digester);
        webDigester.getParser();

        webFragmentRuleSet = new WebRuleSet(true); // <web-fragment>
        webFragmentDigester = DigesterFactory.newDigester(validation,
                namespaceAware, webFragmentRuleSet, blockExternal);//  webFragmentRuleSet.addRuleInstances(digester);
    ...
    public boolean parseWebXml(InputSource source, WebXml dest,
        ...
        if (fragment) {
            ...
            digester = webDigester;//!!!! 走这里
            ruleSet = webRuleSet;
        }

        digester.push(dest);// dest === org.apache.tomcat.util.descriptor.web.WebXml
