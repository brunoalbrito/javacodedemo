...
public class ImplicitObjectELResolver extends ELResolver {
    ...
    public Object getValue(ELContext context, Object base, Object property) {
        ...
        // context == org.apache.el.lang.EvaluationContext
//        如： getValue(EvaluationContext, null, "applicationScope")
//        如： getValue(org.apache.el.lang.EvaluationContext, javax.servlet.jsp.el.ImplicitObjectELResolver.ScopeMap, "username");
        if (base == null && property != null) {
            int idx = Arrays.binarySearch(SCOPE_NAMES, property.toString());
//            SCOPE_NAMES = new String[] {
//                    "applicationScope", "cookie", "header", "headerValues",
//                    "initParam", "pageContext", "pageScope", "param", "paramValues",
//                    "requestScope", "sessionScope" }
            if (idx >= 0) {
                ...
                // page === org.apache.jasper.runtime.PageContextImpl
                context.setPropertyResolved(base, property);
                switch (idx) {
                case APPLICATIONSCOPE:
                    return ScopeManager.get(page).getApplicationScope(); // javax.servlet.jsp.el.ImplicitObjectELResolver.ScopeMap
                case COOKIE:
    ...
    private static class ScopeManager {
        ...
        public Map<String,Object> getApplicationScope() {
            if (this.applicationScope == null) {
                this.applicationScope = new ScopeMap<Object>() { // 创建对象
                    @Override
    ...
    private abstract static class ScopeMap<V> extends AbstractMap<String,V> {
        ...
        @Override
        public final V get(Object key) {  // 取得属性值
            if (key != null) {
