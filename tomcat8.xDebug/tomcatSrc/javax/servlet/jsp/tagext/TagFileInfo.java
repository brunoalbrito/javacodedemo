...
public class TagFileInfo {
    ...
    public TagFileInfo( String name, String path, TagInfo tagInfo ) {
        ...
        this.tagInfo = tagInfo; // 解析 /webapps/examples/WEB-INF/tags/displayProducts.tag 文件的对象树
    }
    ...
    public TagInfo getTagInfo() {
        return tagInfo;  // 解析 /webapps/examples/WEB-INF/tags/displayProducts.tag 文件的对象树
    }
