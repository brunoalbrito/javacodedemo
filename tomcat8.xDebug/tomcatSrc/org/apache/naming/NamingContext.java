...
public class NamingContext implements Context {
    ...
    public void bind(Name name, Object obj)
        throws NamingException {
    	// name === new CompositeName("comp")
    	// obj === NamingContext(env, this.name)
        bind(name, obj, false);
    }
...
//        name === new CompositeName("comp")
    ...
    protected Object lookup(Name name, boolean resolveLinks)
        ...
        NamingEntry entry = bindings.get(name.get(0)); // context1
        ...
        if (name.size() > 1) {  //  context1/context2
            ...
            if ((resolveLinks) && (entry.type == NamingEntry.LINK_REF)) {
                ...
                try {
                    Object obj = NamingManager.getObjectInstance
                        (entry.value, name, this, env); // 创建对象
    ...
    protected void bind(Name name, Object obj, boolean rebind)
        ...
        NamingEntry entry = bindings.get(name.get(0)); // bindings.get("comp")

        // name === javax.naming.CompositeName
        if (name.size() > 1) {  // array("context1","context2")
            if (entry == null) {
            ...
            if ((!rebind) && (entry != null)) {
            	...
            	// obj 是新创建的  NamingContext
				// name  是新创建的  new CompositeName("comp")  
				// this  是本  NamingContext
				// env 是共享的  Hashtable
            	
            	// NamingManager.getStateToBind(NamingContext(env共享对象, "/Catalina/localhost/webapp1"), new CompositeName("comp"), this, env);
                Object toBind =
                    NamingManager.getStateToBind(obj, name, this, env); // toBind === NamingContext(env共享对象, "/Catalina/localhost/webapp1")
                if (toBind instanceof Context) {
//                  entry = new NamingEntry("comp", "新创建的  NamingContext",NamingEntry.CONTEXT);
