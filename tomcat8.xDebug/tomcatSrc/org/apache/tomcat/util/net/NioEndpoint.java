    ...
    public static class PollerEvent implements Runnable {
        ...
        public void run() {
            if (interestOps == OP_REGISTER) {
                try {
                	// socket.getIOChannel() === java.nio.channels.SocketChannel
            ...
            try {
                if ( close ) {
                    ...
                    if (sk.isReadable() || sk.isWritable() ) {
                        if ( attachment.getSendfileData() != null ) { // 文件上传
                ...
                try {
                    if (key != null) {
                        ...
                        if (socket.isHandshakeComplete() || event == SocketEvent.STOP) {
                            ...
                            handshake = socket.handshake(key.isReadable(), key.isWritable()); // 像SSL要进行握手
