...
//         	}
//         }
    	// this.children[0] === org.apache.el.parser.AstIdentifier
    	// base == javax.servlet.jsp.el.ImplicitObjectELResolver.ScopeMap
    	// ctx == org.apache.el.lang.EvaluationContext
        Object base = this.children[0].getValue(ctx);
        // base	= ImplicitObjectELResolver$ScopeManager$7

        int propCount = this.jjtGetNumChildren(); // ==2
        int i = 1;
        Object suffix = null;
        ELResolver resolver = ctx.getELResolver();
        // resolver == org.apache.jasper.el.JasperELResolver
        while (base != null && i < propCount) {
        	// this.children[1] === org.apache.el.parser.AstDotSuffix
            suffix = this.children[i].getValue(ctx);//!!! suffix == "username"
            if (i + 1 < propCount &&
                    (this.children[i+1] instanceof AstMethodParameters)) {
                ...
                ctx.setPropertyResolved(false);
                // resolver == org.apache.jasper.el.JasperELResolver
                // .getValue(org.apache.el.lang.EvaluationContext, javax.servlet.jsp.el.ImplicitObjectELResolver.ScopeMap, "username");
