...
public final class EmbeddedServletOptions implements Options {
    ...
    public File getScratchDir() {
        return scratchDir; // 临时Tomcat的目录，或者系统的临时 // d:/a/b/tomcat/work/Catalina/localhost/test
    }
...
//	            <param-value>d:/a/b/c</param-value>
//	        </init-param>
...
//	    </init-param>
        while( enumeration.hasMoreElements() ) {
            ...
            setProperty( k, v); // 设置属性 <init-param>标签
        }
        ...
        String development = config.getInitParameter("development"); // 开发模式
        if (development != null) {
        ...
        String classpath = config.getInitParameter("classpath"); // 类路径
        if (classpath != null)
         ...
         * scratchdir
         */
        String dir = config.getInitParameter("scratchdir");  // 解析后的代码的存放目录
        if (dir != null) {
            scratchDir = new File(dir);
        } else {
            // First try the Servlet 2.2 javax.servlet.context.tempdir property
        	// scratchDir === d:/a/b/tomcat/work/Catalina/localhost/test 存放class文件的目录
            scratchDir = (File) context.getAttribute(ServletContext.TEMPDIR); // JSP编译后的Servlet.class放到临时目录
            if (scratchDir == null) {
        ...
        // web-application.
        // 从上下文中取得对象 servletContext.getAttribute(SERVLET_CONTEXT_ATTRIBUTE_NAME);
        // context === org.apache.catalina.core.ApplicationContextFacade
        ...
        // Create a Tag plugin instance 插件管理器
