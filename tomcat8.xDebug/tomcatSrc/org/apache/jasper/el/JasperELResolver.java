...
// 	 如:  getValue(org.apache.el.lang.EvaluationContext, javax.servlet.jsp.el.ImplicitObjectELResolver.ScopeMap, "username");
    ...
    public Object getValue(ELContext context, Object base, Object property)
        ...
        context.setPropertyResolved(false); // 未解析到属性
...
//            	javax.servlet.jsp.el.ScopedAttributeELResolver
            	// result == javax.servlet.jsp.el.ImplicitObjectELResolver.ScopeMap
                result = resolvers[i].getValue(context, base, property);
                if (context.isPropertyResolved()) { // true
                    return result;
                }
            }
        ...
        for (int i = start; i < size; i++) {
        	//!!! resolvers[i].getValue(org.apache.el.lang.EvaluationContext, javax.servlet.jsp.el.ImplicitObjectELResolver.ScopeMap, "username");
