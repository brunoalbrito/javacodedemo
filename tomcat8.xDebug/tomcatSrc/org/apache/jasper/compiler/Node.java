...
abstract class Node implements TagConstants {
    ...
    public static class Root extends Node {
        ...
        Root(Mark start, Node parent, boolean isXmlSyntax) {
            super(start, parent);
            this.isXmlSyntax = isXmlSyntax; // false
            this.qName = JSP_ROOT_ACTION; // jsp:root
            this.localName = ROOT_ACTION; // root
    ...
    public static class IncludeDirective extends Node {
        ...
        public IncludeDirective(String qName, Attributes attrs,
                Attributes nonTaglibXmlnsAttrs, Attributes taglibAttrs,
                Mark start, Node parent) {
        	// super("jsp:directive.include","directive.include",attrs("file", "file", "CDATA"),null,null,start, parent)
    ...
    public static class CustomTag extends Node {
        ...
        public CustomTag(String qName, String prefix, String localName,
                ...
                Attributes taglibAttrs, Mark start, Node parent,
                TagInfo tagInfo, Class<?> tagHandlerClass) {
//        	如：this.qName = "myprefix:tagname1";
//          如： this.localName = "tagname1";
//          如：this.attrs = {attr1:"value1" , attr2:"value2"};
        	super(qName, localName, attrs, nonTaglibXmlnsAttrs, taglibAttrs,
                    start, parent);

            this.uri = uri; // 如："http://cn.java/jsp/core"
            this.prefix = prefix; // 如： "myprefix"
            this.tagInfo = tagInfo; // 如： .tld文件的 tag对象树
            this.tagFileInfo = null;
            this.tagHandlerClass = tagHandlerClass; // 如： "cn.java.tag.TagName1Handler"
    ...
    public static class Nodes {
        ...
        public void visit(Visitor v) throws JasperException {
            ...
            while (iter.hasNext()) {
            	// 如： org.apache.jasper.compiler.Node.CustomTag
                Node n = iter.next();
                n.accept(v);
            }
        }
