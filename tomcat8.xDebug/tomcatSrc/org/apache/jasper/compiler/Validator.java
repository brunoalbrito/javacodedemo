...
class Validator {
    ...
    private static class DirectiveVisitor extends Node.Visitor {
        ...
        public void visit(Node.PageDirective n) throws JasperException {
            ...
            for (int i = 0; attrs != null && i < attrs.getLength(); i++) {
                ...
                if ("language".equals(attr)) {
                    if (pageInfo.getLanguage(false) == null) {
                        pageInfo.setLanguage(value, n, err, true); // 页面指令配置的信息设置到 pageInfo中
            ...
            pageInfo.addImports(n.getImports());  // 添加到要导入的信息
        }
        ...
        if (contentType == null || contentType.indexOf("charset=") < 0) {
            ...
            if (isXml) {
                ...
                if (!page.getRoot().isDefaultPageEncoding()) {
                    charset = page.getRoot().getPageEncoding(); // 根节点的页面编码
                }
            }
