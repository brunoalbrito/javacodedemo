...
public class JspConfig {
    ...
    private void processWebDotXml() {
        ...
        if (ctxt.getEffectiveMajorVersion() < 2) { // ctxt.getEffectiveMajorVersion()===3
            defaultIsELIgnored = "true";
            defaultDeferedSyntaxAllowedAsLiteral = "true";
            return;
        }
        // ctxt.getEffectiveMinorVersion() == 0
        ...
        // jspConfig === org.apache.tomcat.util.descriptor.web.JspConfigDescriptorImpl
        ...
        for (JspPropertyGroupDescriptor jspPropertyGroup : jspPropertyGroups) {
        	//jspPropertyGroup === org.apache.tomcat.util.descriptor.web.JspPropertyGroupDescriptorImpl
    ...
    private void init() {
        ...
        if (!initialized) {
            synchronized (this) {
                if (!initialized) {
                    processWebDotXml();//!!!! 读取JSP的配置信息 <jsp-property-group>
                    // 默认JSP的配置信息
    ...
    public JspProperty findJspProperty(String uri) {
        ...
        init(); // 读取JSP的配置信息 <jsp-property-group>
        ...
        while (iter.hasNext()) {
            ...
            JspPropertyGroup jpg = iter.next(); // org.apache.jasper.compiler.JspConfig.JspPropertyGroup
            JspProperty jp = jpg.getJspProperty(); // org.apache.jasper.compiler.JspConfig.JspProperty
            ...
            // 根据访问的JSP文件，匹配的改文件的属性配置<jsp-property-group>
            // We have a match
