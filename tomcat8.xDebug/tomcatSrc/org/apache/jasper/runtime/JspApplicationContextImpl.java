...
public class JspApplicationContextImpl implements JspApplicationContext {
    ...
    private final ExpressionFactory expressionFactory =
            ExpressionFactory.newInstance(); //  //!!! org.apache.el.ExpressionFactoryImpl
    ...
    public static JspApplicationContextImpl getInstance(ServletContext context) {
        ...
        return impl; //!!! org.apache.jasper.runtime.JspApplicationContextImpl
    }
    ...
    public ELContextImpl createELContext(JspContext context) {
        ...
        final ELResolver r = this.createELResolver(); // 创建EL解析器
        ELContextImpl ctx;
        ...
        // context == org.apache.jasper.runtime.PageContextImpl
        ctx.putContext(JspContext.class, context);

        // alert all ELContextListeners
        ELContextEvent event = new ELContextEvent(ctx); // 触发上下文监听器
    ...
    private ELResolver createELResolver() {
        ...
        if (this.resolver == null) {
        	// expressionFactory == org.apache.el.ExpressionFactoryImpl
