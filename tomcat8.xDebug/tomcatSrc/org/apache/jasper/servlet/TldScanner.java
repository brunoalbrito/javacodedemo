...
public class TldScanner {
    ...
    public void scan() throws IOException, SAXException {
        ...
        scanResourcePaths(WEB_INF); // "/WEB-INF/"
...
//            	  </jsp-property-group>
//                <taglib>
//                         <taglib-location>/WEB-INF/taglib/tag1.tld</taglib-location>
//                         <taglib-uri>http://cn.java/jsp/core1</taglib-uri>
//                 </taglib>
//                 <taglib>
...
//    	startPath === "/WEB-INF/"
    ...
    public void scanJars() {
    	// 扫描/WEB-INF/lib/ 中以  .tld结尾的文件 
    	// 扫描/WEB-INF/classes/META-INF 中以  .tld结尾的文件 
    	// 扫描上下文类加载器类路径路径 中以  .tld结尾的文件 
        JarScanner scanner = JarScannerFactory.getJarScanner(context); // org.apache.tomcat.util.scan.StandardJarScanner
        TldScannerCallback callback = new TldScannerCallback();  //jar包中以  .tld结尾的文件 
        ...
        public void scan(Jar jar, String webappPath, boolean isWebapp) throws IOException {
            ...
            for (String entryName = jar.getEntryName();
                ...
                if (!(entryName.startsWith("META-INF/") &&
                        entryName.endsWith(TLD_EXT))) { //jar包中以  .tld结尾的文件
                    continue; 
                }
                // 
                found = true;
