...
public abstract class LifecycleMBeanBase extends LifecycleBase
    ...
    protected void initInternal() throws LifecycleException {
        ...
        if (oname == null) {
            ...
            oname = register(this, getObjectNameKeyProperties()); // 把自己注册到 MBeanServer服务器中
        }
    }
    ...
    protected final ObjectName register(Object obj,
        ...
        StringBuilder name = new StringBuilder(getDomain()); // Catalina
        name.append(':');
        name.append(objectNameKeyProperties); // 如： "type=Server"
        ...
        try {
            ...
            Registry.getRegistry(null, null).registerComponent(obj, on, null); //  把自己注册到 MBeanServer服务器中
