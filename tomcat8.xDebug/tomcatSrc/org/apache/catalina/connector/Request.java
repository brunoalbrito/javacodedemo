...
public class Request implements org.apache.catalina.servlet4preview.http.HttpServletRequest {
    ...
    public void setCoyoteRequest(org.apache.coyote.Request coyoteRequest) {
        ...
        inputBuffer.setRequest(coyoteRequest); // 设置原生请求对象
    }
    ...
    public String changeSessionId() {
        ...
        manager.changeSessionId(session); // 修改SessionID
...
//	    </web-app>
    ...
    protected void parseParameters() {
        ...
        try {
            ...
            if (enc != null) {
                parameters.setEncoding(enc); // 设置参数的编码类型
                if (useBodyEncodingForURI) {
                    parameters.setQueryStringEncoding(enc); // 设置url的编码类型
                }
            } else { // 默认会走这边
            ...
            if (len > 0) {
                int maxPostSize = connector.getMaxPostSize();  // 提交的最大大小
