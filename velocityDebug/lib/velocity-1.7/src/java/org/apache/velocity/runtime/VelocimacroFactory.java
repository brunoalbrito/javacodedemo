...
public class VelocimacroFactory
{
    ...
    public void initVelocimacro()
    {
        ...
        synchronized(this)
        {
             ...
             */
             ...
             Object libfiles = rsvc.getProperty(RuntimeConstants.VM_LIBRARY); // velocimacro.library
             ...
             if (libfiles == null)
             {
                 ...
                 if (rsvc.getLoaderNameForResource(RuntimeConstants.VM_LIBRARY_DEFAULT) != null) // "VM_global_library.vm"
                 {
                 ...
                 for(int i = 0, is = macroLibVec.size(); i < is; i++)
                 {
                     ...
                     if (StringUtils.isNotEmpty(lib))
                     {
                         ...
                         try
                         {
                             ...
                             libModMap.put(lib, twonk); // libModMap['VM_global_library.vm']
                         }
                         catch (Exception e)
                         {
    ...
    public boolean dumpVMNamespace(String namespace)
    {
        ...
        return vmManager.dumpNamespace(namespace); // namespace==test.vm 
    }
