...
public class RuntimeInstance implements RuntimeConstants, RuntimeServices
{
    ...
    {
        String[] uberspectors = configuration.getStringArray(RuntimeConstants.UBERSPECT_CLASSNAME); // "runtime.introspector.uberspect"
        for (int i=0; i <uberspectors.length;i++)
        {
            ...
            try
            {
               o = ClassUtils.getNewInstance( rm ); // org.apache.velocity.util.introspection.UberspectImpl
            }
    ...
    private void setDefaultProperties()
    {
        ...
        try
        {
            inputStream = getClass()
                .getResourceAsStream('/' + DEFAULT_RUNTIME_PROPERTIES); // '/org/apache/velocity/runtime/defaults/velocity.properties'
    ...
    private void initializeProperties()
    {
         ...
         */
        if (configuration.isInitialized() == false) // org.apache.commons.collections.ExtendedProperties
        {
            setDefaultProperties(); // 加载默认配置 '/org/apache/velocity/runtime/defaults/velocity.properties'
        }

        if( overridingProperties != null)
        {
            configuration.combine(overridingProperties); // 和自定义配置合并
        }
    }
    ...
    private void initializeResourceManager()
    {
        ...
        if (rm != null && rm.length() > 0)
        {
            ...
            try
            {
               o = ClassUtils.getNewInstance( rm ); // org.apache.velocity.runtime.resource.ResourceManagerImpl
            }
            catch (ClassNotFoundException cnfe )
            {
    ...
    private void initializeEventHandlers()
    {
        ...
        String[] referenceinsertion = configuration.getStringArray(RuntimeConstants.EVENTHANDLER_REFERENCEINSERTION); // eventhandler.referenceinsertion.class
        ...
        String[] nullset = configuration.getStringArray(RuntimeConstants.EVENTHANDLER_NULLSET); // eventhandler.nullset.class
        if ( nullset != null )
        {
        ...
        String[] methodexception = configuration.getStringArray(RuntimeConstants.EVENTHANDLER_METHODEXCEPTION); // eventhandler.methodexception.class
        ...
        String[] includeHandler = configuration.getStringArray(RuntimeConstants.EVENTHANDLER_INCLUDE); // eventhandler.include.class
        ...
        String[] invalidReferenceSet = configuration.getStringArray(RuntimeConstants.EVENTHANDLER_INVALIDREFERENCES); // eventhandler.invalidreferences.class
    ...
    private void initializeDirectives()
    {
        ...
        try
        {
            inputStream = getClass().getResourceAsStream('/' + DEFAULT_RUNTIME_DIRECTIVES); // "/org/apache/velocity/runtime/defaults/directive.properties"
    ...
    private void initializeParserPool()
    {
         ...
         * Which parser pool?
         */
        String pp = getString(RuntimeConstants.PARSER_POOL_CLASS); // parser.pool.class
        ...
        if (pp != null && pp.length() > 0)
        {
            ...
            try
            {
                o = ClassUtils.getNewInstance( pp ); // org.apache.velocity.runtime.ParserPoolImpl
            }
            catch (ClassNotFoundException cnfe )
            {
        ...
        throws ParseException
    {
        ...
        try
        {
            ...
            if (dumpNamespace)
            {
                dumpVMNamespace(templateName);//!!  test.vm
            }
            return parser.parse(reader, templateName); // org.apache.velocity.runtime.parser.Parser
        }
        finally
        {
            if (keepParser)
    ...
    {
        String property = evaluateScopeName+'.'+PROVIDE_SCOPE_CONTROL; // evaluate.provide.scope.control
    ...
    public String getLoaderNameForResource(String resourceName)
    {
        ...
        return resourceManager.getLoaderNameForResource(resourceName); // org.apache.velocity.runtime.resource.ResourceManagerImpl 资源管理器
    }
    ...
    */
    ...
    {
        return vmFactory.dumpVMNamespace( namespace ); // org.apache.velocity.runtime.VelocimacroFactory
    }
