    ...
    implements ResourceManager
{
    ...
    public synchronized void initialize(final RuntimeServices rsvc)
    {
        ...
        /*
	        sourceInitializerList = [ // "resource.loader"
	             { // "loaderName1.resource.loader"
	            	 "property1":"property1Value",
	            	 "property2":"property2Value",
	            	 "_RESOURCE_LOADER_IDENTIFIER_" : "loaderName1"
	             },
	             {
	            	 "property1":"property1Value",
	            	 "property2":"property2Value",
	            	 "_RESOURCE_LOADER_IDENTIFIER_" : "loaderName2"
	             },
	             {
	            	 ...
	            	 "_RESOURCE_LOADER_IDENTIFIER_" : "file"
	             }
	        ]
         */
    ...
    {
        Vector resourceLoaderNames = rsvc.getConfiguration().getVector(RuntimeConstants.RESOURCE_LOADER); // "resource.loader"
        ...
        for (Iterator it = resourceLoaderNames.iterator(); it.hasNext(); )
        {
            ...
            loaderID.append(".").append(RuntimeConstants.RESOURCE_LOADER);  // "loaderName1.resource.loader"
            ...
            ParseErrorException
    {
    	...
    	// resourceType === ResourceManager.RESOURCE_TEMPLATE 1 表示模板资源
        String resourceKey = resourceType + resourceName; // resourceKey == "1test.vm"
